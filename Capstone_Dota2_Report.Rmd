...
```{r players_ratings_csv2,echo=FALSE}
...
## Correlation between game duration and winning team (radiant or dire)
A scatterplot between game duration and winning team is plotted. TRUE or FALSE are categorical  variables with respect to radiant team winning. True implies that radiant team has won and vice versa. Shape of the two plots are very similar showing that length of the game does not offer an advantage to any team.
```{r match_csv,echo=FALSE}
